...
class AttendanceRepository {
    ...
    async createAttendance(date, studentId, instructorId, status, classNumber) {
    ...
    async findAttendanceByDateAndStudent(date, studentId) {
    ...
    async findClassNumberForDate(date) {
        const validDate = new Date(date);
        const formattedDate = validDate.toISOString().split('T')[0];
        ...
        const isNewSemester = currentYear > lastYear ||
    ...
    async findLastGlobalClassNumber() {
    ...
    async getUserAttendancesWithClassPlans(filters) {
    ...
    async getStudentClassPlansWithAttendance(userId) {
